                ...
                <Container className="px-5 py-5 mt-4 mb-4">
                    <Row>
                        <Col xs={11} md={10} lg={8}>
                            ...
                            <p className="fs-5 mb-4">I use MERN stack to build website. Based on Semarang, Indonesia.</p>
                            <a href="https://github.com/bramtriprastowo" target="_blank" rel="noreferrer">
