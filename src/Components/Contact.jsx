        ...
        return (
            <StyledSection id="contact">
                <Container className="px-5 py-4 mt-4 mb-5">
                    <Row>
                        <Col>
                            <h4 className="display-6 fw-bolder mb-5 pb-3 text-center">Contact Me</h4>
                            <StyledForm action="#" method="post" className="mx-auto">
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Control as="textarea" size="sm" placeholder="Your Message" style={{ height: '94px' }}></Form.Control>
                                </Form.Group>
                                <Form.Group className="d-grid">
                                    <Button variant="dark" type="submit" className="button-submit">Submit</Button>
                                </Form.Group>
                            </StyledForm>
                        </Col>
                    </Row>
